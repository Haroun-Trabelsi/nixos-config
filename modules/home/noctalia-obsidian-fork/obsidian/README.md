...
> Locally patched fork (nixos-config): the **Recent** tab can read a
> selected note's text in-panel and rename it. Not upstream
> davemhammer/obsidian — see `modules/home/noctalia-plugins.nix` in this repo.
